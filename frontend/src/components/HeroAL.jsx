    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      p-4 sm:p-6 md:p-8 lg:p-10`}
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-black drop-shadow-lg leading-tight">
            Welcome to <span className="text-blue-950">JalSetu</span>
          </h1>

          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white font-medium leading-relaxed mb-6 sm:mb-8 px-1 sm:px-2 md:px-4">
