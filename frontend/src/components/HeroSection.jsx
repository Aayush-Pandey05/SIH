  ...
  return (
    ...
    >
      <div className="flex justify-center w-full mb-6">
        <div className="drop flex items-center justify-center mb-4 sm:mb-6 bg-blue-100 rounded-full w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 shadow-md">
          <Droplet
            className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-blue-500"
            fill="currentColor"
          />
        </div>
      </div>
      ...
      <p className="hero-text text-base sm:text-lg md:text-xl text-gray-600 max-w-xl sm:max-w-2xl mx-auto mb-8 px-2 sm:px-0">
        ...
        smart alerts, government integration, and WebAR visualization to make
        RWH accessible and efficient for every Indian citizen.
      </p>

      <Link to="/map-roof" className="hero-text">
        <button className="bg-blue-500 hover:bg-blue-600 text-white px-5 sm:px-6 py-3 sm:py-3.5 rounded-lg shadow-lg font-medium transition text-sm sm:text-base md:text-lg">
