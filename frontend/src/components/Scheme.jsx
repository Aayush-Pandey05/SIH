...
const SchemeCard = ({ item, handleViewDetails, isVisible }) => (
  <div
    className={`scheme-card bg-slate-800/50 backdrop-blur-sm rounded-xl shadow-lg border border-slate-700 p-6 flex flex-col justify-between h-full min-h-[260px] transform transition-all duration-500 hover:-translate-y-2 hover:border-cyan-400/50 overflow-hidden relative ${
